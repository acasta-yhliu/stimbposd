...
from stimbposd.bp_osd import BPLSD  # noqa: F401
from stimbposd.bp_lsd import BPLSD  # noqa: F401
from stimbposd.sinter_bp_osd import SinterDecoder_BPLSD  # noqa: F401
...
def sinter_decoders() -> Dict[str, Decoder]:
    return {"bposd": SinterDecoder_BPLSD(), "bplsd": SinterDecoder_BPLSD()}
